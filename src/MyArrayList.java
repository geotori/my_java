...
/**public class MyArrayList<E> extends MyAbstractList<E> {
    ...
    @Override // Return the element at the specified position in this list. Shift any subsequent elements
    // to the left. Return the element that was removed from the list.
    ...
    @Override // Override iterator() defines in Iterable
