public class TestMyLinkedList {
    public static void main(String[] args) {
        ...
        list.add(2, "Germany"); // Add it to the list at the index of 2
        System.out.println("(5)" + list);

        list.add(5, "Norway"); // Add it to the list at the index of 5
        ...
        list.remove(2); // Remove the element at the index of 2
